...
def UDS_SAPR_get_log(self: Packet) -> Tuple[str, Any]:
...
def UDS_WMBAPR_get_log(self: Packet) -> Tuple[str, Any]:
    addr = getattr(self, "memoryAddress%d" % self.memoryAddressLen)
    size = getattr(self, "memorySize%d" % self.memorySizeLen)
...
def UDS_CDTCI_get_log(self: Packet) -> Tuple[str, Any]:
    return self.sprintf("%UDS.service%"), \
...
def UDS_CDTCIPR_get_log(self: Packet) -> Tuple[str, Any]:
    return self.sprintf("%UDS.service%"), None


@Ecu.extend_pkt_with_logging(UDS_RDTCI)
def UDS_RDTCI_get_log(self: Packet) -> Tuple[str, Any]:
    return self.sprintf("%UDS.service%"), repr(self)


@Ecu.extend_pkt_with_logging(UDS_RDTCIPR)
def UDS_RDTCIPR_get_log(self: Packet) -> Tuple[str, Any]:
    return self.sprintf("%UDS.service%"), repr(self)


@Ecu.extend_pkt_with_logging(UDS_RC)
def UDS_RC_get_log(self: Packet) -> Tuple[str, Any]:
    return self.sprintf("%UDS.service%"),\
...
def UDS_RCPR_get_log(self: Packet) -> Tuple[str, Any]:
    return self.sprintf("%UDS.service%"),\
        (self.routineControlType,
         self.routineIdentifier)
...
def UDS_RD_get_log(self: Packet) -> Tuple[str, Any]:
    addr = getattr(self, "memoryAddress%d" % self.memoryAddressLen)
    size = getattr(self, "memorySize%d" % self.memorySizeLen)
    return self.sprintf("%UDS.service%"), (addr, size)
...
def UDS_RDPR_get_log(self: Packet) -> Tuple[str, Any]:
    return self.sprintf("%UDS.service%"), self.memorySizeLen


@Ecu.extend_pkt_with_logging(UDS_RU)
def UDS_RU_get_log(self: Packet) -> Tuple[str, Any]:
    addr = getattr(self, "memoryAddress%d" % self.memoryAddressLen)
    size = getattr(self, "memorySize%d" % self.memorySizeLen)
    return self.sprintf("%UDS.service%"), (addr, size)
